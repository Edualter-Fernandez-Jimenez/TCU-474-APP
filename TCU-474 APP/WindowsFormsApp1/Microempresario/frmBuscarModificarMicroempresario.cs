...
{
    public partial class frmBuscarModificarMicroempresario : Form
    {
        ...
        public frmBuscarModificarMicroempresario()
        {
            InitializeComponent();
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                frmModificarMicroempresario frmModificar = new frmModificarMicroempresario(idMicroempresario);
                frmModificar.Show();
        ...
        private void dgvMicroempresarios_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
